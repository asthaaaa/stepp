...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void everyAttendeeIsConsideredWithOptionalAttendeeBusyAllDay() {
    ...
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_B)),
        new Event("Event 3", TimeRange.fromStartDuration(TimeRange.START_OF_DAY, 1440),
    ...
    @Test
  public void everyAttendeeIsConsideredWithOptionalAttendeeinBetween() {
...
@Test
public void noMandatoryCandidate(){
        Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartDuration(TIME_0830AM, DURATION_60_MINUTES),
            Arrays.asList(PERSON_A)),
...
request.addOptionalAttendee(PERSON_B);
    ...
    Collection<TimeRange> expected =
        Arrays.asList(TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_0830AM, false),
        TimeRange.fromStartDuration(TIME_0930AM, 90),
            TimeRange.fromStartEnd(TIME_1200AM, TimeRange.END_OF_DAY, true));

    Assert.assertEquals(expected, actual);
}
@Test
public void noMandatoryCandidateWithnogap(){
        Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_0830AM, false),
            Arrays.asList(PERSON_A)),
